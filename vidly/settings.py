...
SECRET_KEY = "django-insecure-$^36zgg65na&c@2ygsl)*x0k=+(13ovcgtu3p3=+!in1+-u#*n"
...
CORS_ORIGIN_WHITELIST = [
     'https://touaresmovier.netlify.app/',
]
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, 'vidly_frontend/build')],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
# ]
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'vidly_frontend/build','static'),
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'vidly_frontend/build','static'),
